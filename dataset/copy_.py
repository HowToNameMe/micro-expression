...
if __name__=='__main__':
    os.makedirs("./Mixed_dataset/train")
    ...
    os.makedirs("./Mixed_dataset/test")
    for fold in os.path.join("megc2022-synthesis/source_samples_cropped"):
        for item in os.path.join("megc2022-synthesis/source_samples_cropped", fold):
            src_fold = os.path.join("megc2022-synthesis/source_samples_cropped", fold, item)
            tgt_fold = "./Mixed_dataset/test"
            shutil.copy(src_fold, tgt_fold)
    ...
    for name in os.path.join("megc2022-synthesis/target_template_face_cropped"):
