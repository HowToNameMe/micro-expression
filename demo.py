...
if __name__ == "__main__":
    ...
    parser.add_argument("--src_drv_csv", default='/home/data1/xieguochen/Competition/MEGC2022/data/Mixed_dataset/Mixed_dataset_test.csv', help="path to csv file")
    ...
    for i in range(len(data['driving'])):
        ...
        src_img = os.listdir(os.path.join("/home/data1/xieguochen/Competition/MEGC2022/data/Mixed_dataset/test",src_dir))[0]
        source_image = imageio.imread(os.path.join("/home/data1/xieguochen/Competition/MEGC2022/data/Mixed_dataset/test",src_dir,src_img))

        if os.path.exists(os.path.join("/home/data1/xieguochen/Competition/MEGC2022/data/Mixed_dataset/test_mask",src_dir)):
            src_img_mask = os.listdir(os.path.join("/home/data1/xieguochen/Competition/MEGC2022/data/Mixed_dataset/test_mask",src_dir))[0]
            source_image_mask = imageio.imread(os.path.join("/home/data1/xieguochen/Competition/MEGC2022/data/Mixed_dataset/test_mask",src_dir,src_img_mask))
        ...
        driving_video = []
        drv_vid_files = os.listdir(os.path.join("/home/data1/xieguochen/Competition/MEGC2022/data/Mixed_dataset/test",drv_vid))
        ...
        for im in drv_vid_files:
            driving_video.append(imageio.imread(os.path.join("/home/data1/xieguochen/Competition/MEGC2022/data/Mixed_dataset/test",drv_vid,im)))
