...
def train_avd(config, inpainting_network, kp_detector, bg_predictor, fg_predictor, dense_motion_network, 
    ...
    if checkpoint is not None:
        Logger.load_cpk(checkpoint, inpainting_network=inpainting_network, kp_detector=kp_detector,
                                      bg_predictor=bg_predictor, fg_predictor=fg_predictor, avd_network=avd_network,
        ...
        for epoch in trange(start_epoch, train_params['num_epochs']):
            ...
            with torch.no_grad():
                ...
                dense_motion = dense_motion_network(source_image=source, kp_driving=kp_driving,
                                            kp_source=kp_source)
                generated = inpainting_network(source, mask, dense_motion)
            ...
            # print(epoch,model_save.keys(),source.size(),driving.size(),generated.keys())
